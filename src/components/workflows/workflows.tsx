...
export const WorkflowsPagination = () => {
  const [data] = useSuspenseWorkflows();
  const { totalPages, page, totalCount } = data;
  const [params, setParams] = useWorkflowsParams();
...
export const WorkflowItem = ({ data }: { data: Workflow }) => {
  ...
  return (
    <EntityItem
      ...
      image={
        <div className="flex items-center justify-center size-10 rounded-lg bg-primary/10 text-primary transition-colors duration-200 group-hover:bg-primary/15">
