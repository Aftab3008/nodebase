  ...
  return (
    <>
      ...
      `}
        ...
        >
          <div className="spinner rounded-full bg-[conic-gradient(from_0deg_at_50%_50%,oklch(from_var(--primary)_l_c_h/0.5)_0deg,oklch(from_var(--primary)_l_c_h/0)_360deg)]" />
        </div>
      </div>
      {children}
    </>
